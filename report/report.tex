...
Relative to one node, two-node latency increases by 20.5\% (32-token), 27.3\% (128-token), and 24.9\% (512-token). Four-node latency increases by 60.2\%, 77.1\%, and 75.3\%, respectively. Under this implementation, added communication dominates reduced per-stage compute.
